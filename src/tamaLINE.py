...
>>>>>>> 028c222f76ca3a16372a5fd81ec2800748d5ebdc
            ...
            await enhsleep(ctx, 1)
            await servant.knowledgebox("As expected of you, having become totally dependent on me, you are not able to do anything properly anymore, ", tag, ".")
            await enhsleep(ctx, 1)
            await servant.knowledgebox("But please refrain yourself from acting rashly from now on, as it would be troubling to the medical staff and Mashu, and other Tamamo if you get injured in the middle of you action, ", tag, ".")
            await enhsleep(ctx, 1)
            await servant.knowledgebox("Otherwise I will not forgive you the next time you injured yourself due to not using your brain, ", tag, ".")
            await enhsleep(ctx, 1)
            await servant.knowledgebox("What, I'm being to harsh on you, ", tag, "?")
            await enhsleep(ctx, 1)
            await servant.knowledgebox("Are you perhaps expecting me to be sweeter toward you because I'm your girlfriend, ", tag, "?")
            await enhsleep(ctx, 1)
            await servant.convbox("Then it's impossible, I'm a tsundere after all.")
            await enhsleep(ctx, 1)
            await servant.knowledgebox("And isn't that a Strategist/Girlfriend 's responsibility is to keep their loved one, in this case, you, alive, right ", tag, "?")
            await enhsleep(ctx, 1)
